...
class _StringsNl implements Translations {
	...
	@override String get polls_and_quizes => 'Polls en quizzen';
	@override String get record => 'Dossier';
	@override String get stop_recording => 'Stop met opnemen';
	@override String get are_you_sure_stop_recording => 'Weet u zeker dat u de opname wilt stoppen? Je\n kunt deze actie niet ongedaan maken.';
	...
	@override String get pause_chat => 'Pauzeer het chatten';
	...
	@override String get poll => 'opiniepeiling';
	@override String get quiz => 'Quiz';
	@override String get create => 'creëren';
	@override String get hide_vote_count => 'Verberg het aantal stemmen';
	...
	@override String get hide_for_everyone => 'Verberg voor iedereen';
	@override String get copy_text => 'Kopieer tekst';
	...
	@override String get minimize_tile => 'Minimaliseer uw tegel';
...
extension on _StringsNl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'polls_and_quizes': return 'Polls en quizzen';
			case 'record': return 'Dossier';
			case 'stop_recording': return 'Stop met opnemen';
			case 'are_you_sure_stop_recording': return 'Weet u zeker dat u de opname wilt stoppen? Je\n kunt deze actie niet ongedaan maken.';
			...
			case 'pause_chat': return 'Pauzeer het chatten';
			...
			case 'poll': return 'opiniepeiling';
			case 'quiz': return 'Quiz';
			case 'create': return 'creëren';
			case 'hide_vote_count': return 'Verberg het aantal stemmen';
			...
			case 'hide_for_everyone': return 'Verberg voor iedereen';
			case 'copy_text': return 'Kopieer tekst';
			...
			case 'minimize_tile': return 'Minimaliseer uw tegel';
